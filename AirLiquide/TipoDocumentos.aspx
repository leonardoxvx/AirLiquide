<%@ Page Title="" Language="C#" MasterPageFile="~/Sitio.Master" AutoEventWireup="true" CodeBehind="TipoDocumentos.aspx.cs" Inherits="Cobros30.TipoDocumentos" %>
                ...
                <asp:GridView ID="grvTipoDocumento" runat="server" ClientIDMode="Static" CssClass="table table-responsive table-hover table-condensed table-bordered table-striped small"
                    ...
                    <Columns>
                        <asp:TemplateField HeaderText="ID">
                            <ItemTemplate>
                                <asp:Label ID="lblIdTipoDocumento" runat="server" Text='<%# Bind("IdTipoDocumento") %>' Visible="true"></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField HeaderText="Nombre Tipo Documento">
                            <ItemTemplate>
                                <asp:Label ID="lblNomTipoDocumento" runat="server" Text='<%# Bind("NomTipoDocumento") %>'></asp:Label>
                            </ItemTemplate>
                        </asp:TemplateField>
                        ...
                        <div class="row">
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <asp:TextBox ID="txtTipoDocumento" runat="server" CssClass="form-control input-sm"></asp:TextBox>
                                    <asp:HiddenField ID="hfIdTipoDocumento" runat="server" />
                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ControlToValidate="txtTipoDocumento" ErrorMessage="Debe ingresar un nombre" CssClass="label label-danger"></asp:RequiredFieldValidator>
                                </div>
                                <div class="form-group">
